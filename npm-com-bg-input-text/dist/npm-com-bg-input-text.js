    ...
    [
      _vm._ssrNode(
        _vm.type !== "textarea"
          ? (_vm.type !== "textarea"
              ? "<input" +
                _vm._ssrAttr("tabindex", _vm.tabindex) +
                _vm._ssrAttr("placeholder", _vm.placeholder) +
                _vm._ssrAttr("autocomplete", _vm.autocomplete) +
                _vm._ssrAttr("readonly", _vm.readonly) +
                ...
                _vm._ssrAttr("aria-label", _vm.label) +
                _vm._ssrAttrs(_vm.$attrs) +
                ' class="npm-com-bg-input__inner">'
              : "<!---->") +
              " " +
              (_vm.showClear || _vm.showPassword
                ? '<span class="npm-com-bg-input__suffix"><span class="npm-com-bg-input__suffix-inner">' +
                  (_vm.showClear
                    ? '<i class="npm-com-bg-input__icon npm-com-bg-input__clear"></i>'
                    : "<!---->") +
                  " " +
                  (_vm.showPwdVisible
                    ? '<i class="npm-com-bg-input__icon npm-com-bg-input__showPwd"></i>'
                    : "<!---->") +
                  "</span></span>"
                : "<!---->")
          : "<textarea" +
              ...
              _vm._ssrAttr("autocomplete", _vm.autocomplete) +
              _vm._ssrAttrs(_vm.$attrs) +
              ' class="npm-com-bg-textarea__inner"></textarea>'
      )
    ]
  )
}
...
module.exports.__inject__ = function (context) {
  add("fb8ceb4a", content, false, context)
};
...
//# sourceMappingURL=npm-com-bg-input-text.js.map