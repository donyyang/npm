        ...
        use: [
          ...
          },
          {
            ...
            options: {
              ...
              outputStyle: config.env.mini ? 'compressed' : 'expanded',
              sourceComments: config.env.mini ? false : true,
              sourceMap: config.env.mini ? false : true,
              sourceMapContents: config.env.mini ? false : true,
              sourceMapEmbed: config.env.mini ? false : true,
            },
          },
          replaceLoader,
        ],
