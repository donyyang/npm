...
var isModule = _path.default.basename(_path.default.resolve('')).startsWith('npm-');
    ...
    }, // scss-loader
    {
      ...
      use: [{
        ...
        options: {
          ...
          outputStyle: _npmBuildConfig.default.env.mini || isModule ? 'compressed' : 'expanded',
          sourceComments: _npmBuildConfig.default.env.mini || isModule ? false : true,
          sourceMap: _npmBuildConfig.default.env.mini || isModule ? false : true,
          sourceMapContents: _npmBuildConfig.default.env.mini || isModule ? false : true,
          sourceMapEmbed: _npmBuildConfig.default.env.mini || isModule ? false : true
        }
      }]
    }, // img-loader
    {
