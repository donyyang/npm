    ...
    [
      _vm._ssrNode(
        (_vm.showTotal
          ? '<span class="pagination-total">' +
            _vm._ssrEscape("共 " + _vm._s(_vm.total) + " 条") +
            "</span>"
          : "<!---->") +
          ' <button type="button"' +
          _vm._ssrAttr(
            "disabled",
            _vm.disabled || _vm.internalCurrentPage <= 1
          ) +
      ...
      _vm._ssrNode(
        ' <button type="button"' +
          ...
          (_vm.jump
            ? '<span class="pagination_jump"><span class="jump_text">前往</span> <div class="pagination-input"><input' +
              _vm._ssrAttr("disabled", _vm.disabled) +
              ' type="number"' +
              _vm._ssrAttr("min", 1) +
              _vm._ssrAttr("max", _vm.internalCurrentPage) +
              _vm._ssrAttr("value", _vm.internalCurrentPage) +
              ' class="input-inner"></div> <span class="jump_text">页</span></span>'
            : "<!---->")
      )
    ],
    2
    ...
    [
      _vm._ssrNode(
        (_vm.pageCount > 0
          ...
          (_vm.showPrevMore
            ? "<li" +
              _vm._ssrClass("more btn-quickprev", { disabled: _vm.disabled }) +
              "></li>"
            : "<!---->") +
          " " +
          _vm._ssrList(_vm.pagers, function(pager) {
            return (
              "<li" +
              _vm._ssrClass("number", {
          ...
          (_vm.showNextMore
            ? "<li" +
              _vm._ssrClass("more btn-quicknext", { disabled: _vm.disabled }) +
              "></li>"
            : "<!---->") +
          " " +
          (_vm.pageCount > 1
            ? "<li" +
              ...
              ">" +
              _vm._ssrEscape(_vm._s(_vm.pageCount)) +
              "</li>"
            : "<!---->")
      )
    ]
...
//# sourceMappingURL=npm-com-bg-pagination.js.map